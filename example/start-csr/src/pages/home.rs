...
pub fn Home() -> impl IntoView {
    view! {
        <section class="container flex-1 flex flex-col gap-10">
            <div class="flex flex-col w-full gap-4 items-center text-center lg:text-start pt-20">
                <div class="flex gap-2 lg:gap-4 items-center">
                    <div
                        class="w-[40px] md:w-[60px] bg-muted rounded-full border"
                        inner_html=include_str!("../../../../logo.svg")
                    ></div>
                    <h1 class="text-center text-3xl font-bold leading-tight tracking-tight md:text-6xl lg:leading-[1.1]">
                        <span class="inline-block text-transparent bg-clip-text bg-gradient-to-r from-primary to-red-600 p-2">
                            Leptos Query
                        </span>
                    </h1>
                </div>
                <h2 class="font-bold text-xl max-w-md md:text-2xl lg:max-w-2xl">
                    Robust async state management for
                    <a
                        href="https://leptos.dev"
                        target="_blank"
                        rel="noopener noreferrer"
                        class="text-primary underline decoration-primary transition-colors hover:text-primary/80"
                    >
                        Leptos
                    </a>
                </h2>
                ...
                <span
                    ...
                    style="display: inline-block; vertical-align: top; text-decoration: inherit; max-width: 570px;"
                >
                    Say goodbye to complex state management and tangled async code. Embrace Leptos
                    {"Query's"}
                    sleek, declarative approach for effortless data fetching and state sync.
                </span>
            ...
            <div class="flex flex-col lg:flex-row items-stretch gap-8 p-8 max-w-[1200px] mx-auto lg:min-h-72">
                ...
                <InfoCard title="Developer First">
                    <div class="h-full flex flex-col justify-between items-start">
                        <p>
                            Designed with developers in mind, Leptos Query includes
                            <Loud>comprehensive devtools</Loud>
                            and simplifies async state to directly improve developer & user experiences
                        </p>
...
fn InfoCard(#[prop(into)] title: String, children: Children) -> impl IntoView {
    view! {
        <div class="flex-1 flex flex-col gap-8 items-center p-4 rounded-xl border">
            <div class="flex flex-col gap-4 flex-1">
                <h3 class="text-center text-lg text-foreground font-bold">{title}</h3>
